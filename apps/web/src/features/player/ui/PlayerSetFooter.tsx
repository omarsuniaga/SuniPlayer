        ...
        <div style={{
            ...
            <div style={{ flex: 1 }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                    <span style={{ fontSize: isMobile ? 10 : 12, fontWeight: 700, color: THEME.colors.text.muted }}>SET PROGRESS</span>
                    <span style={{ fontSize: isMobile ? 10 : 12, fontWeight: 700, color: mCol, fontFamily: THEME.fonts.mono }}>{fmtM(qTot)} TOTAL</span>
                </div>
            ...
            {!isLive && (
                ...
                >
                    <svg width={isMobile ? 10 : 12} height={isMobile ? 10 : 12} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                        <path d="M21 15v4a2 2 0 0 1-2 2H5a2 0 0 1-2-2v-4" />
                        <polyline points="7 10 12 15 17 10" />
                        <line x1="12" y1="15" x2="12" y2="3" />
                    </svg>
                    <span style={{ fontSize: isMobile ? 10 : 11, fontWeight: 600 }}>{isMobile ? "" : "Export"}</span>
                </button>
            )}
            ...
            >
                {isLive
                    ? <svg width={isMobile ? 11 : 13} height={isMobile ? 11 : 13} viewBox="0 0 24 24" fill="none" stroke={THEME.colors.brand.cyan} strokeWidth="2.5" strokeLinecap="round">
                        <rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" />
                    </svg>
                    : <svg width={isMobile ? 11 : 13} height={isMobile ? 11 : 13} viewBox="0 0 24 24" fill="none" stroke={THEME.colors.text.muted} strokeWidth="2.5" strokeLinecap="round">
                        <rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 9.9-1" />
                    </svg>
                }
                <span style={{ fontSize: isMobile ? 10 : 12, color: isLive ? THEME.colors.brand.cyan : THEME.colors.text.muted, fontWeight: 700 }}>
                    {isLive ? "LIVE" : "EDIT"}
                </span>
            </button>
        </div>
