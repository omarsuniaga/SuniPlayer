...
export class SQLiteStorage implements IStorage {
  ...
  async exportFullBackup(): Promise<Blob> {
    // TODO: Implement native backup logic (bundle SQLite DB + FileSystem audio files)
    throw new Error('exportFullBackup not yet implemented on Native');
  }

  async importFullBackup(backup: Blob): Promise<{ success: boolean; count: number }> {
    // TODO: Implement native restore logic
    throw new Error('importFullBackup not yet implemented on Native');
  }
}
