 ...
 * NOTE: Platform-specific side effects (confirm dialog, storage clear, page reload)
 * must be handled by the calling app layer before invoking this function.
 * The web app wraps this with confirm() + localStorage.clear() + window.location.reload().
 */
